...
(function() {
    var moduleName     = 'authors-abm',
        controllerName = 'authorsEditController';
    controller.$inject = ['$scope',"$http","$timeout","$location","countries"];

    function controller($scope,$http,$timeout,$location,countrySelect) {
